...
const Login = () => {
    ...
    return (
        <div className="min-h-screen pt-20 flex items-center justify-center relative overflow-hidden">
            {/* Background Elements */}
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-purple/20 rounded-full blur-[100px] -z-10 animate-pulse-slow"></div>
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-brand-blue/20 rounded-full blur-[100px] -z-10 animate-pulse-slow delay-1000"></div>

            <div className="w-full max-w-md p-8 glass rounded-2xl animate-fade-in-up">
                <h2 className="text-3xl font-heading font-bold text-center mb-6 text-gradient">Welcome Back</h2>
                ...
                {/* Help Box for Email Confirmation */}
                <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                    <div className="flex gap-2 items-start text-yellow-200 text-sm">
                        <Mail className="shrink-0 mt-0.5" size={16} />
                        <p>
                            <strong>Can't login?</strong> Check your email inbox for a confirmation link.
                            If you still can't access, ask the administrator to disable "Confirm Email" in Supabase.
                        </p>
                    </div>
                </div>
                ...
                <p className="mt-6 text-center text-gray-400 text-sm">
                    ...
                    <Link to="/signup" className="text-brand-purple hover:text-brand-blue transition-colors font-medium">
                        Sign Up
                    </Link>
                </p>
            </div>
